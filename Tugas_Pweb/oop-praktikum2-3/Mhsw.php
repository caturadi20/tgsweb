...
class Mhsw {
    ...
    {
        $sql = "insert into tbl_mhsw values ('','".$_GET['mhsw_nim']."','".$_GET['mhsw_nama']."','".$_GET['mhsw_alamat']."')";
        $stmt = $this->db->prepare($sql);
        $stmt->execute();
    ...
    {
        $sql = "delete from tbl_mhsw where mhsw_id='".$_GET['mhsw_id']."'";
        $stmt = $this->db->prepare($sql);
        $stmt->execute();
    ...
    {
        $sql = "SELECT * FROM tbl_mhsw where mhsw_id='".$_GET['mhsw_id']."'";
        $stmt = $this->db->prepare($sql);
        $stmt->execute();
        $data = [];
        while ($rows = $stmt->fetch()) {
